...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>Moja oprema</h2>
    <a href="{{ route('provider.create-equipment') }}" class="btn btn-success">Dodaj novu opremu</a>
</div>
        ...
        <div class="col">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-2"><strong>Cena:</strong> <span class="text-primary fw-bold">{{ $item->price_per_day }} din/dan</span></p>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <form action="{{ route('provider.delete-equipment', $item->id) }}" method="POST" class="flex-fill">
                            ...
                            <button type="submit" class="btn btn-sm btn-danger w-100"
                                    onclick="return confirm('Da li ste sigurni da zelite da obrisete ovu opremu?')">
                                Obrisi
                            </button>
                        </form>
                    </div>
...
@else
    <div class="alert alert-info">
        <p class="mb-0">Jos uvek niste dodali opremu. <a href="{{ route('provider.create-equipment') }}" class="alert-link">Dodajte prvu opremu</a></p>
    </div>
@endif
@endsection